...
export default async function AdminPage() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-6 text-red-700">Panel de Administración Secreto</h1>
      <p>Bienvenido, **{session.user.name}**, solo los administradores tienen acceso aquí.</p>
      <p className="mt-4">
